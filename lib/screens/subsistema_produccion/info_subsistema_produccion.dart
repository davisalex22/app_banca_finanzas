            ...
            column1: Column(
              children: [
                CardInformationTable(titleCategory: 'Producción', dataRow: [
                  ...
                  buildCellTableSubs(
                      'Atributos fisicos', value.prodMatCalidadAtributos, 1),
                  buildCellTableSubs('Estandarización',
                      value.prodMatCalidadEstandarizacion, 1),
                  buildCellTableSubs(
                      'Trabajabilidad', value.prodMatCalidadTrabajabilidad, 1),
                  buildCellTableSubs(
                      'Disponibilidad', value.prodMatCalidadDisponibilidad, 1),
                  buildCellTableSubs(
                      'Tiempo entrega', value.prodMatCalidadEntregas, 1),
                  buildCellTableSubs('Precio', value.prodMatCalidadPrecio, 1),
                ]),
                const LineDivider(),
                CardInformationTable(
                    ...
                    dataRow: [
                      ...
                      buildCellTableSubs('Clientes', value.prodUbiClientes, 1),
                      buildCellTableSubs(
                          'Medio de ambiente', value.prodUbiMedioAmbiente, 1),
                      buildCellTableSubs(
                ...
                CardInformationTable(
                    ...
                    dataRow: [
                      buildCellTableSubs("Edificio", value.prodLugEdificio, 3),
                      buildCellTableSubs('Espacio', value.prodLugEspacio, 3),
                      ...
                      buildCellTableSubs(
                          'Ambientación\ncolores', value.prodLugAmbColores, 1),
                      buildCellTableSubs('Ambientación\nventilación',
                      ...
                      buildCellTableSubs(
                          ...
                          1),
                      buildCellTableSubs(
                          'Ambientación\nlockers', value.prodLugAmbLockers, 1),
                      buildCellTableSubs('Ambientación\nalimentos',
                      ...
                      buildCellTableSubs(
                          'Distribución\npor línea', value.prodLugDisLinea, 1),
                    ]),
                const LineDivider(),
                CardInformationTable(
                    ...
                    dataRow: [
                      ...
                      buildCellTableSubs(
                          'Costos variables', value.prodProcCostosVariables, 1),
                      buildCellTableSubs(
                ...
                CardInformationTable(titleCategory: 'Maquinaria', dataRow: [
                  buildCellTableSubs("Adecuada", value.prodMaqSuficiente, 2),
                  buildCellTableSubs("Suficiente", value.prodMaqSuficiente, 2),
                  buildCellTableSubs(
